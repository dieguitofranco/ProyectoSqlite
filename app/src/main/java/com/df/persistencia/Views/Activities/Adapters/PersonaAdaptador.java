...
public class PersonaAdaptador extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView textNamePerson = v.findViewById(R.id.textName);
        TextView textDocument = v.findViewById(R.id.textDocumento);
        TextView textEdad = v.findViewById(R.id.textEdad);
        TextView textEmail = v.findViewById(R.id.textEmail);
        TextView textPhone = v.findViewById(R.id.textTelefono);
